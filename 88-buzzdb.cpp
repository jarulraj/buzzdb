...
public:
    ...
    void printStatsAndEstimates(const std::string& query,
        ...
        auto planned_query = chooseGreedyCostBasedPlan(
            components,
            stats,
            ordered_output_required
        );
        ...
        planned_query_cache[join_body_query] =
            chooseGreedyCostBasedPlan(
...
int main(int argc, char* argv[]) {
    ...
    std::cout << "\nQuery optimization with physical join costing" << std::endl;
