...
void runImdbJoinOrdering() {
    ...
    auto greedy_plan = chooseGreedyJoinOrder(
        components,
        stats,
        SelectivityModel::MostCommonValues
    );
    auto selinger_result = chooseSelingerLeftDeepJoinOrder(
        components,
        stats,
        SelectivityModel::MostCommonValues
    );
    const auto& selinger_plan = selinger_result.plan;
    printJoinOrderPlan("MCV-greedy optimizer order", greedy_plan, db.catalog);
    ...
    auto greedy_join_kinds = physicalJoinKindsForPlan(greedy_plan);
    auto selinger_join_kinds = physicalJoinKindsForPlan(selinger_plan);
