...
void runImdbJoinOrdering() {
    ...
    auto uniform_plan = db.optimizer().chooseGreedyJoinOrder(
        components,
        stats,
    ...
    db.optimizer().printJoinQErrorReport(
    ...
    auto uniform_join_kinds =
        db.optimizer().physicalJoinKindsForPlan(uniform_plan);
    auto mcv_join_kinds =
        db.optimizer().physicalJoinKindsForPlan(mcv_plan);
