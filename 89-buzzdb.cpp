...
void runImdbJoinOrdering() {
    ...
    std::cout << "\nUniform greedy first two decisions:" << std::endl;
    for (const auto& line : uniform_greedy_trace) {
        std::cout << line << std::endl;
    }
    std::cout << "\nMCV greedy first two decisions:" << std::endl;
